...
import javafx.ag8.list.ListController;
...
public class AddController implements Initializable {
    ...
    public void add(ActionEvent actionEvent){
        try {
            ...
            for (Book b: ListController.bookList) {
            ...
            ListController.bookList.add(new Book(id, name, author, publisher, type, price, quantity));
